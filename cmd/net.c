...
static int do_bootp(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_tftpput(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_tftpsrv(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
...
static int do_nfs(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_ping(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	if (argc < 2)
		return CMD_RET_USAGE;
