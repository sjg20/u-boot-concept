...
static int do_fat_ls(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_fat_fswrite(struct cmd_tbl *cmdtp, int flag,
...
static int do_fat_rm(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
