...
static int do_get_fat(struct cmd_tbl *cmdtp, const char *file_path, char *file_addr)
{
 ...
 */
static int do_sysboot(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
