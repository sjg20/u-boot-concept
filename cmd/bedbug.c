 ...
 * ====================================================================== */
int do_bedbug_dis (struct cmd_tbl * cmdtp, int flag, int argc, char * const argv[])
{
 ...
 * ====================================================================== */
int do_bedbug_asm (struct cmd_tbl * cmdtp, int flag, int argc, char * const argv[])
{
...
int do_bedbug_break (struct cmd_tbl * cmdtp, int flag, int argc, char * const argv[])
{
	/* -------------------------------------------------- */
	if (bug_ctx.do_break)
 ...
 * return.
 * ====================================================================== */
int do_bedbug_continue (struct cmd_tbl * cmdtp, int flag, int argc, char * const argv[])
{
	/* -------------------------------------------------- */
 ...
 * ====================================================================== */
int do_bedbug_step (struct cmd_tbl * cmdtp, int flag, int argc, char * const argv[])
{
 ...
 * for the current breakpoint number.
 * ====================================================================== */
int do_bedbug_next (struct cmd_tbl * cmdtp, int flag, int argc, char * const argv[])
{
	unsigned long addr;	/* Address to stop at */
 ...
 * ====================================================================== */
int do_bedbug_stack (struct cmd_tbl * cmdtp, int flag, int argc, char * const argv[])
{
 ...
 * ====================================================================== */
int do_bedbug_rdump (struct cmd_tbl * cmdtp, int flag, int argc, char * const argv[])
{
	/* -------------------------------------------------- */
