...
static int do_mem_md(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_mem_mm(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	return mod_mem (cmdtp, 1, flag, argc, argv);
}
static int do_mem_nm(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	return mod_mem (cmdtp, 0, flag, argc, argv);
}

static int do_mem_mw(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_mem_mdc(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	int i;
	ulong count;
...
static int do_mem_mwc(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	int i;
	ulong count;
...
static int do_mem_cmp(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_mem_cp(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
 ...
 */
static int
mod_mem(struct cmd_tbl *cmdtp, int incrflag, int flag, int argc, char * const argv[])
{
	ulong	addr;
#ifdef MEM_SUPPORT_64BIT_DATA
	u64 i;
...
static int do_mem_crc(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	int flags = 0;
	int ac;
	char * const *av;
...
static int do_random(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
