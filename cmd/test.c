...
static int do_test(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	char * const *ap;
...
static int do_false(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	return 1;
}
...
static int do_true(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	return 0;
}
