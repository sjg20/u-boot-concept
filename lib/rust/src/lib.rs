...
pub mod uboot_api {
    ...
    extern "C" {
        ...
        /// # Returns
        ///
        /// The number of characters which would be generated for the given input,
        /// excluding the trailing null, as per ISO C99
        pub fn ub_snprintf(
            buf: *mut c_char,
            size: usize,
            fmt: *const c_char,
