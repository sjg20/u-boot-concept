...
static int tps80031_poweroff(struct udevice *dev)
{
	return pmic_reg_write(dev, TPS80031_PHOENIX_DEV_ON, DEVOFF);
}
...
static int tps80031_probe(struct udevice *dev)
{
