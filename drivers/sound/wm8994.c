...
static int wm8994_init_volume_aif1_dac1(void)
{
	...
	/* unmute AIF1DAC1 */
	ret |= wm8994_i2c_write(WM8994_AIF1_DAC1_FILTERS_1, 0x0000);
...
static int wm8994_device_init(struct wm8994_priv *wm8994)
{
	...
	ret |= wm8994_i2c_write(WM8994_POWER_MANAGEMENT_5, WM8994_AIF1DAC1L_ENA
			| WM8994_AIF1DAC1R_ENA | WM8994_DAC1L_ENA
			| WM8994_DAC1R_ENA);
