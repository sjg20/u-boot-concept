...
#define TPS65913_LDO9_CTRL_DATA		(0x0100 | TPS65913_LDO9_CTRL)
#define TPS65913_LDO9_VOLTAGE_DATA	(0x3100 | TPS65913_LDO9_VOLTAGE)
...
void pmic_enable_cpu_vdd(void)
{
	...
	/* Set SD IO to 3.300V.*/
	tegra_i2c_ll_write(TPS65913_I2C_ADDR, TPS65913_LDO9_VOLTAGE_DATA);
	udelay(1000);
	tegra_i2c_ll_write(TPS65913_I2C_ADDR, TPS65913_LDO9_CTRL_DATA);
	udelay(10 * 1000);
}
