...
//PRM_TAMPER
#define RM_TAMPER_CONTEXT				(PRCM_BASE_ADDR + 0x0624)

//PRM_CEFUSE
#define PM_CEFUSE_PWRSTCTRL				(PRCM_BASE_ADDR + 0x0700)
#define PM_CEFUSE_PWRSTST				(PRCM_BASE_ADDR + 0x0704)
#define RM_CEFUSE_CONTEXT				(PRCM_BASE_ADDR + 0x0724)

//PRM_PER
#define	PM_PER_PWRSTCTRL				(PRCM_BASE_ADDR + 0x0800)
#define	PM_PER_PWRSTST					(PRCM_BASE_ADDR + 0x0804)
#define	RM_PER_RSTCTRL					(PRCM_BASE_ADDR + 0x0810)
#define	RM_PER_RSTST					(PRCM_BASE_ADDR + 0x0814)
#define	RM_PER_L3_CONTEXT				(PRCM_BASE_ADDR + 0x0824)
#define	RM_PER_AES0_CONTEXT				(PRCM_BASE_ADDR + 0x082C)
#define	RM_PER_DES_CONTEXT				(PRCM_BASE_ADDR + 0x0834)
#define	RM_PER_CRYPTODMA_CONTEXT		(PRCM_BASE_ADDR + 0x083C)
#define	RM_PER_L3_INSTR_CONTEXT			(PRCM_BASE_ADDR + 0x0844)
#define	RM_PER_MSTR_EXPS_CONTEXT		(PRCM_BASE_ADDR + 0x084C)
#define	RM_PER_OCMCRAM_CONTEXT			(PRCM_BASE_ADDR + 0x0854)
#define	RM_PER_SHA0_CONTEXT				(PRCM_BASE_ADDR + 0x085C)
#define	RM_PER_SLV_EXPS_CONTEXT			(PRCM_BASE_ADDR + 0x0864)
#define	RM_PER_VPFE0_CONTEXT			(PRCM_BASE_ADDR + 0x086C)
#define	RM_PER_VPFE1_CONTEXT			(PRCM_BASE_ADDR + 0x0874)
#define	RM_PER_TPCC_CONTEXT				(PRCM_BASE_ADDR + 0x087C)
#define	RM_PER_TPTC0_CONTEXT			(PRCM_BASE_ADDR + 0x0884)
#define	RM_PER_TPTC1_CONTEXT			(PRCM_BASE_ADDR + 0x088C)
#define	RM_PER_TPTC2_CONTEXT			(PRCM_BASE_ADDR + 0x0894)
#define	RM_PER_DLL_AGING_CONTEXT		(PRCM_BASE_ADDR + 0x089C)
#define	RM_PER_L4HS_CONTEXT				(PRCM_BASE_ADDR + 0x08A4)
#define	RM_PER_L4FW_CONTEXT				(PRCM_BASE_ADDR + 0x08AC)
#define	RM_PER_GPMC_CONTEXT				(PRCM_BASE_ADDR + 0x0A24)
#define	RM_PER_IEEE5000_CONTEXT			(PRCM_BASE_ADDR + 0x0A2C)
#define	RM_PER_MAG_CARD_CONTEXT			(PRCM_BASE_ADDR + 0x0A34)
#define	RM_PER_MCASP0_CONTEXT			(PRCM_BASE_ADDR + 0x0A3C)
#define	RM_PER_MCASP1_CONTEXT			(PRCM_BASE_ADDR + 0x0A44)
#define	RM_PER_MMC2_CONTEXT				(PRCM_BASE_ADDR + 0x0A4C)
#define	RM_PER_QSPI_CONTEXT				(PRCM_BASE_ADDR + 0x0A5C)
#define	RM_PER_USB_OTG_SS0_CONTEXT		(PRCM_BASE_ADDR + 0x0A64)
#define	RM_PER_USB_OTG_SS1_CONTEXT		(PRCM_BASE_ADDR + 0x0A6C)
#define	RM_PER_ICSS_CONTEXT				(PRCM_BASE_ADDR + 0x0B24)
#define	RM_PER_L4LS_CONTEXT				(PRCM_BASE_ADDR + 0x0C24)
#define	RM_PER_DCAN0_CONTEXT			(PRCM_BASE_ADDR + 0x0C2C)
#define	RM_PER_DCAN1_CONTEXT			(PRCM_BASE_ADDR + 0x0C34)
#define	RM_PER_EPWMSS0_CONTEXT			(PRCM_BASE_ADDR + 0x0C3C)
#define	RM_PER_EPWMSS1_CONTEXT			(PRCM_BASE_ADDR + 0x0C44)
#define	RM_PER_EPWMSS2_CONTEXT			(PRCM_BASE_ADDR + 0x0C4C)
#define	RM_PER_EPWMSS3_CONTEXT			(PRCM_BASE_ADDR + 0x0C54)
#define	RM_PER_EPWMSS4_CONTEXT			(PRCM_BASE_ADDR + 0x0C5C)
#define	RM_PER_EPWMSS5_CONTEXT			(PRCM_BASE_ADDR + 0x0C64)
#define	RM_PER_ELM_CONTEXT				(PRCM_BASE_ADDR + 0x0C6C)
#define	RM_PER_ERMC_CONTEXT				(PRCM_BASE_ADDR + 0x0C74)
#define	RM_PER_GPIO1_CONTEXT			(PRCM_BASE_ADDR + 0x0C7C)
#define	RM_PER_GPIO2_CONTEXT			(PRCM_BASE_ADDR + 0x0C84)
#define	RM_PER_GPIO3_CONTEXT			(PRCM_BASE_ADDR + 0x0C8C)
#define	RM_PER_GPIO4_CONTEXT			(PRCM_BASE_ADDR + 0x0C94)
#define	RM_PER_GPIO5_CONTEXT			(PRCM_BASE_ADDR + 0x0C9C)
#define	RM_PER_HDQ1W_CONTEXT			(PRCM_BASE_ADDR + 0x0CA4)
#define	RM_PER_I2C1_CONTEXT				(PRCM_BASE_ADDR + 0x0CAC)
#define	RM_PER_I2C2_CONTEXT				(PRCM_BASE_ADDR + 0x0CB4)
#define	RM_PER_MAILBOX0_CONTEXT			(PRCM_BASE_ADDR + 0x0CBC)
#define	RM_PER_MMC0_CONTEXT				(PRCM_BASE_ADDR + 0x0CC4)
#define	RM_PER_MMC1_CONTEXT				(PRCM_BASE_ADDR + 0x0CCC)
#define	RM_PER_PKA_CONTEXT				(PRCM_BASE_ADDR + 0x0CD4)
#define	RM_PER_RNG_CONTEXT				(PRCM_BASE_ADDR + 0x0CE4)
#define	RM_PER_SPARE0_CONTEXT			(PRCM_BASE_ADDR + 0x0CEC)
#define	RM_PER_SPARE1_CONTEXT			(PRCM_BASE_ADDR + 0x0CF4)
#define	RM_PER_SPI0_CONTEXT				(PRCM_BASE_ADDR + 0x0D04)
#define	RM_PER_SPI1_CONTEXT				(PRCM_BASE_ADDR + 0x0D0C)
#define	RM_PER_SPI2_CONTEXT				(PRCM_BASE_ADDR + 0x0D14)
#define	RM_PER_SPI3_CONTEXT				(PRCM_BASE_ADDR + 0x0D1C)
#define	RM_PER_SPI4_CONTEXT				(PRCM_BASE_ADDR + 0x0D24)
#define	RM_PER_SPINLOCK_CONTEXT			(PRCM_BASE_ADDR + 0x0D2C)
#define	RM_PER_TIMER2_CONTEXT			(PRCM_BASE_ADDR + 0x0D34)
#define	RM_PER_TIMER3_CONTEXT			(PRCM_BASE_ADDR + 0x0D3C)
#define	RM_PER_TIMER4_CONTEXT			(PRCM_BASE_ADDR + 0x0D44)
#define	RM_PER_TIMER5_CONTEXT			(PRCM_BASE_ADDR + 0x0D4C)
#define	RM_PER_TIMER6_CONTEXT			(PRCM_BASE_ADDR + 0x0D54)
#define	RM_PER_TIMER7_CONTEXT			(PRCM_BASE_ADDR + 0x0D5C)
#define	RM_PER_TIMER8_CONTEXT			(PRCM_BASE_ADDR + 0x0D64)
#define	RM_PER_TIMER9_CONTEXT			(PRCM_BASE_ADDR + 0x0D6C)
#define	RM_PER_TIMER10_CONTEXT			(PRCM_BASE_ADDR + 0x0D74)
#define	RM_PER_TIMER11_CONTEXT			(PRCM_BASE_ADDR + 0x0D7C)
#define	RM_PER_UART1_CONTEXT			(PRCM_BASE_ADDR + 0x0D84)
#define	RM_PER_UART2_CONTEXT			(PRCM_BASE_ADDR + 0x0D8C)
#define	RM_PER_UART3_CONTEXT			(PRCM_BASE_ADDR + 0x0D94)
#define	RM_PER_UART4_CONTEXT			(PRCM_BASE_ADDR + 0x0D9C)
#define	RM_PER_UART5_CONTEXT			(PRCM_BASE_ADDR + 0x0DA4)
#define	RM_PER_USIM0_CONTEXT			(PRCM_BASE_ADDR + 0x0DAC)
#define	RM_PER_USIM1_CONTEXT			(PRCM_BASE_ADDR + 0x0DB4)
#define	RM_PER_USBPHYOCP2SCP0_CONTEXT	(PRCM_BASE_ADDR + 0x0DBC)
#define	RM_PER_USBPHYOCP2SCP1_CONTEXT	(PRCM_BASE_ADDR + 0x0DC4)
#define	RM_PER_EMIF_CONTEXT				(PRCM_BASE_ADDR + 0x0F24)
#define	RM_PER_DLL_CONTEXT				(PRCM_BASE_ADDR + 0x0F2C)
#define	RM_PER_EMIF_FW_CONTEXT			(PRCM_BASE_ADDR + 0x0F34)
#define	RM_PER_OTFA_EMIF_CONTEXT		(PRCM_BASE_ADDR + 0x0F3C)
#define	RM_PER_LCDC_CONTEXT				(PRCM_BASE_ADDR + 0x1024)
#define	RM_PER_DSS_CONTEXT				(PRCM_BASE_ADDR + 0x1224)
#define	RM_PER_CPGMAC0_CONTEXT			(PRCM_BASE_ADDR + 0x1324)
#define	RM_PER_OCPWP_CONTEXT			(PRCM_BASE_ADDR + 0x1424)

//PRM_WKUP
#define RM_WKUP_RSTCTRL					(PRCM_BASE_ADDR + 0x2010)
#define RM_WKUP_RSTST					(PRCM_BASE_ADDR + 0x2014)
#define RM_WKUP_DEBUGSS_CONTEXT			(PRCM_BASE_ADDR + 0x2024)
#define RM_WKUP_ADC_TSC_CONTEXT			(PRCM_BASE_ADDR + 0x2124)
#define RM_WKUP_L4WKUP_CONTEXT			(PRCM_BASE_ADDR + 0x2224)
#define RM_WKUP_WKUP_M3_CONTEXT			(PRCM_BASE_ADDR + 0x222C)
#define RM_WKUP_SYNCTIMER_CONTEXT		(PRCM_BASE_ADDR + 0x2234)
#define RM_WKUP_TIMER0_CONTEXT			(PRCM_BASE_ADDR + 0x2324)
#define RM_WKUP_TIMER1_CONTEXT			(PRCM_BASE_ADDR + 0x232C)
#define RM_WKUP_WDT0_CONTEXT			(PRCM_BASE_ADDR + 0x2334)
#define RM_WKUP_WDT1_CONTEXT			(PRCM_BASE_ADDR + 0x233C)
#define RM_WKUP_I2C0_CONTEXT			(PRCM_BASE_ADDR + 0x2344)
#define RM_WKUP_UART0_CONTEXT			(PRCM_BASE_ADDR + 0x234C)
#define RM_WKUP_SMARTREFLEX0_CONTEXT	(PRCM_BASE_ADDR + 0x2354)
#define RM_WKUP_SMARTREFLEX1_CONTEXT	(PRCM_BASE_ADDR + 0x235C)
#define RM_WKUP_GPIO0_CONTEXT			(PRCM_BASE_ADDR + 0x236C)
...
#define CLKSEL_MAG_CARD_CLK             (PRCM_BASE_ADDR + 0x424C)
#define CLKSEL_DLL_AGING_CLK            (PRCM_BASE_ADDR + 0x4250)
#define CLKSEL_USIM0_FCLK               (PRCM_BASE_ADDR + 0x4254)
#define CLKSEL_USIM1_FCLK               (PRCM_BASE_ADDR + 0x4258)
#define CLKSEL_USIM_DBCLK               (PRCM_BASE_ADDR + 0x425C)
...
//CM_TAMPER
#define CM_TAMPER_CLKSTCTRL             (PRCM_BASE_ADDR + 0x8600)
#define CM_TAMPER_TPMSS_CLKCTRL         (PRCM_BASE_ADDR + 0x8620)
...
#define CM_PER_MAG_CARD_CLKCTRL         (PRCM_BASE_ADDR + 0x8A30)
...
#define CM_PER_ERMC_CLKCTRL             (PRCM_BASE_ADDR + 0x8C70)
...
#define CM_PER_USIM0_CLKCTRL            (PRCM_BASE_ADDR + 0x8DA8)
#define CM_PER_USIM1_CLKCTRL            (PRCM_BASE_ADDR + 0x8DB0)
...
#define CM_PER_LCDC_CLKSTCTRL           (PRCM_BASE_ADDR + 0x9000)
#define CM_PER_LCDC_CLKCTRL             (PRCM_BASE_ADDR + 0x9020)
...
#define TAMPER_CTRL                     (CONTROL_BASE_ADDR + 0x01DC)
...
#define DIE_ID2                         (CONTROL_BASE_ADDR + 0x1824)
#define ID_UNLOCK1                      (CONTROL_BASE_ADDR + 0x1828)
#define ID_UNLOCK2                      (CONTROL_BASE_ADDR + 0x182C)
#define DIE_ID0                         (CONTROL_BASE_ADDR + 0x183C)
#define ID_UNLOCK0                      (CONTROL_BASE_ADDR + 0x1844)
#define DIE_ID1                         (CONTROL_BASE_ADDR + 0x1848)
#define ID_UNLOCK3                      (CONTROL_BASE_ADDR + 0x184C)
#define DIE_ID3                         (CONTROL_BASE_ADDR + 0x1850)

#define CANARY_EN_0                     (CONTROL_BASE_ADDR + 0x3880)
#define CANARY_EN_1                     (CONTROL_BASE_ADDR + 0x3884)
#define CANARY_STAT_0                   (CONTROL_BASE_ADDR + 0x3890)
#define CANARY_STAT_1                   (CONTROL_BASE_ADDR + 0x3894)
#define CANARY_FSM_CTRL                 (CONTROL_BASE_ADDR + 0x38A0)



//****************************************************
//Tamper Subsystem definitions
//****************************************************
#define TPMSS_BASE_ADDR                     (0x44e88000)

#define TPMSS_BBD_TAMPER_CTRL               (TPMSS_BASE_ADDR + 0x01DC)

#define TPMSS_BBD_REDUNDANT_CONFIG_REGS_1   (TPMSS_BASE_ADDR + 0x5010)
#define TPMSS_BBD_LOCK0                     (TPMSS_BASE_ADDR + 0x73E0)
#define TPMSS_BBD_LOCK1                     (TPMSS_BASE_ADDR + 0x73E4)
...
#define EMIF_READ_IDLE_CTRL_SHDW        (EMIF_BASE_ADDR + 0x009C)
