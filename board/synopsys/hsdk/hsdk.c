...
static int do_hsdk_go(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	int ret;
...
static int do_hsdk_init(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
...
static int do_hsdk_clock(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	struct cmd_tbl *c;
