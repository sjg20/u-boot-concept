 ...
 */
static int pixis_set_sgmii(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	int which_tsec = -1;
	unsigned char mask;
...
static int pixis_reset_cmd(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	unsigned int i;
	char *p_cf = NULL;
