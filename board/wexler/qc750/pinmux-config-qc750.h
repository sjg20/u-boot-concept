...
#ifndef _PINMUX_CONFIG_QC750_H_
#define _PINMUX_CONFIG_QC750_H_
...
static struct pmux_pingrp_config qc750_pinmux_common[] = {
	/* SDMMC1 pinmux */
	...
	/* ULPI pinmux */
	DEFAULT_PINMUX(ULPI_DATA0_PO1,      ULPI,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(ULPI_DATA1_PO2,      ULPI,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(ULPI_DATA2_PO3,      ULPI,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(ULPI_DATA3_PO4,      ULPI,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(ULPI_DATA4_PO5,      SPI2,       NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(ULPI_DATA5_PO6,      SPI2,       NORMAL,    NORMAL,   INPUT),
	...
	DEFAULT_PINMUX(ULPI_DIR_PY1,        ULPI,       NORMAL,    NORMAL,  OUTPUT),
	...
	DEFAULT_PINMUX(DAP3_SCLK_PP3,       I2S2,       NORMAL,  TRISTATE,  OUTPUT),
	...
	DEFAULT_PINMUX(PV3,                 RSVD2,      NORMAL,  TRISTATE,  OUTPUT),
	...
	DEFAULT_PINMUX(LCD_DC0_PN6,         DISPLAYA,   NORMAL,    NORMAL,  OUTPUT),
	...
	/* VI-group pinmux */
	LV_PINMUX(VI_D0_PT4,                VI,        NORMAL,  TRISTATE,  OUTPUT,  DISABLE,  DISABLE),
	LV_PINMUX(VI_D1_PD5,                VI,        NORMAL,  TRISTATE,  OUTPUT,  DISABLE,  DISABLE),
	...
	LV_PINMUX(VI_D10_PT2,               VI,        NORMAL,  TRISTATE,  OUTPUT,  DISABLE,  DISABLE),
	LV_PINMUX(VI_D11_PT3,               VI,        NORMAL,  TRISTATE,  OUTPUT,  DISABLE,  DISABLE),
	...
	/* U-gpio group pinmux */
	DEFAULT_PINMUX(PU0,                 RSVD4,      NORMAL,    NORMAL,  OUTPUT),
	...
	DEFAULT_PINMUX(CLK3_REQ_PEE1,       DEV3,       NORMAL,  TRISTATE,  OUTPUT),
	...
	DEFAULT_PINMUX(PBB5,                VGP5,           UP,    NORMAL,   INPUT),
	...
	DEFAULT_PINMUX(KB_ROW4_PR4,         KBC,        NORMAL,    NORMAL,  OUTPUT),
	...
	DEFAULT_PINMUX(KB_ROW11_PS3,        KBC,            UP,  TRISTATE,   INPUT),
	DEFAULT_PINMUX(KB_ROW12_PS4,        KBC,        NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(KB_ROW13_PS5,        KBC,        NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(KB_ROW14_PS6,        KBC,        NORMAL,  TRISTATE,  OUTPUT),
	...
	DEFAULT_PINMUX(KB_COL4_PQ4,         KBC,        NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(KB_COL5_PQ5,         KBC,        NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(KB_COL6_PQ6,         KBC,        NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(KB_COL7_PQ7,         KBC,        NORMAL,  TRISTATE,  OUTPUT),
	...
	/* PEX pinmux */
	DEFAULT_PINMUX(PEX_L0_PRSNT_N_PDD0,  PCIE,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(PEX_L0_RST_N_PDD1,    PCIE,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(PEX_L0_CLKREQ_N_PDD2, PCIE,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(PEX_WAKE_N_PDD3,      PCIE,       NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(PEX_L1_PRSNT_N_PDD4,  PCIE,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(PEX_L1_RST_N_PDD5,    PCIE,       NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(PEX_L1_CLKREQ_N_PDD6, PCIE,       NORMAL,  TRISTATE,  OUTPUT),
	...
	DEFAULT_PINMUX(GMI_WAIT_PI7,        RSVD1,          UP,    NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_ADV_N_PK0,       RSVD1,      NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(GMI_CLK_PK1,         NAND,       NORMAL,  TRISTATE,  OUTPUT), //not changed
	DEFAULT_PINMUX(GMI_CS0_N_PJ0,       RSVD1,      NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_CS1_N_PJ2,       RSVD1,      NORMAL,  TRISTATE,  OUTPUT),
	DEFAULT_PINMUX(GMI_CS2_N_PK3,       RSVD1,          UP,    NORMAL,  OUTPUT),
	DEFAULT_PINMUX(GMI_CS3_N_PK4,       RSVD1,      NORMAL,    NORMAL,  OUTPUT),
	DEFAULT_PINMUX(GMI_CS4_N_PK2,       RSVD1,      NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_CS6_N_PI3,       NAND,       NORMAL,  TRISTATE,  OUTPUT),
	...
	DEFAULT_PINMUX(GMI_AD10_PH2,        PWM2,       NORMAL,    NORMAL,  OUTPUT),
	DEFAULT_PINMUX(GMI_AD11_PH3,        PWM3,       NORMAL,    NORMAL,  OUTPUT),
	DEFAULT_PINMUX(GMI_AD12_PH4,        RSVD1,      NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_AD13_PH5,        RSVD1,      NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_AD14_PH6,        RSVD1,      NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_AD15_PH7,        RSVD1,      NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_A16_PJ7,         UARTD,      NORMAL,    NORMAL,  OUTPUT),
	DEFAULT_PINMUX(GMI_A17_PB0,         UARTD,      NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(GMI_A18_PB1,         SPI4,       NORMAL,    NORMAL,  OUTPUT),
	DEFAULT_PINMUX(GMI_A19_PK7,         GMI,        NORMAL,    NORMAL,  OUTPUT),
...
static struct pmux_drvgrp_config qc750_padctrl[] = {
