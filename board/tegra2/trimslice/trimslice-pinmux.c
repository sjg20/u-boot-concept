...
static struct tegra_pingroup_config trimslice_pinmux[] = {
	...
	/* {TEGRA_PINGROUP_CDEV1, TEGRA_MUX_AUDIO,         TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_TRISTATE}, */
	/* {TEGRA_PINGROUP_CDEV2, TEGRA_MUX_AUDIO,         TEGRA_PUPD_PULL_DOWN, TEGRA_TRI_TRISTATE}, */
	/* {TEGRA_PINGROUP_CRTP,  TEGRA_MUX_NONE,          TEGRA_PUPD_NORMAL,    TEGRA_TRI_TRISTATE}, */
	...
	{TEGRA_PINGROUP_SDD,   TEGRA_MUX_SPI3,           TEGRA_PUPD_PULL_UP,   TEGRA_TRI_TRISTATE},
	...
	/* {TEGRA_PINGROUP_UAD,   TEGRA_MUX_SPI4,          TEGRA_PUPD_PULL_UP,   TEGRA_TRI_TRISTATE}, */
