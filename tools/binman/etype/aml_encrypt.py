...
class Entry_aml_encrypt(Entry_section):
    ...
    def BuildSectionData(self, required):
        ...
        output_fname = tools.get_output_filename('aml-out.%s' % uniq)
        ...
        if self._aml_input:
            input_pathname = tools.get_input_filename(
                self._aml_input,
        ...
        for entry in self._entries.values():
            ...
            if isinstance(entry, Entry_blob_ext_list):
                ...
                fname = tools.get_output_filename('aml-in.%s' %
                                                entry.GetUniqueName())
        ...
        data = tools.read_file(real_outfile)
        return data
