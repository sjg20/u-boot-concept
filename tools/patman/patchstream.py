...
def fix_patch(backup_dir, fname, series, cmt, keep_change_id=False, cwd=None):
...
def fix_patches(series, fnames, keep_change_id=False, cwd=None):
    ...
    for fname in fnames:
        ...
        result = fix_patch(backup_dir, fname, series, cmt,
                           keep_change_id=keep_change_id, cwd=cwd)
        if result:
