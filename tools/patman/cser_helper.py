...
class CseriesHelper:
    ...
    def get_now(self):
        ...
        This function should always be used to read the datetime, so that faking
        the time works correctly in tests
    ...
    def _get_autolink_dict(self, sdict, link_all_versions):
        ...
        if link_all_versions:
            for svinfo in self._get_ser_ver_list():
    ...
    async def _sync_all(self, client, pwork, show_cover_comments, to_fetch):
