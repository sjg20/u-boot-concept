...
def send(args, git_dir=None, cwd=None):
    ...
    """
    col = terminal.Color()
    series_info, cover_fname, patch_files = prepare_patches(
        col, args.branch, args.count, args.start, args.end,
        args.ignore_binary, args.add_signoff,
        keep_change_id=args.keep_change_id, git_dir=git_dir, cwd=cwd)
    ok = check_patches(series_info, patch_files, args.check_patch,
    ...
    email_patches(
        col, series_info, cover_fname, patch_files, args.process_tags,
