...
static int cedit_render(struct unit_test_state *uts)
{
	...
	theme->menu_title_margin_x = 20;
	theme->textline_label_margin_x = 20;
	...
	ut_asserteq(168, obj->bbox.x0);
	ut_asserteq(160, obj->bbox.y0);
	ut_asserteq(168 + 277, obj->bbox.x1);
	ut_asserteq(160 + 18, obj->bbox.y1);

	ut_assertok(expo_render(exp));
	ut_asserteq(4889, video_compress_fb(uts, dev, false));
	...
	ut_assertok(cedit_do_action(exp, scn, vid_priv, &act));
	ut_assertok(expo_render(exp));
	ut_asserteq(5412, video_compress_fb(uts, dev, false));
	...
	ut_assertok(cedit_do_action(exp, scn, vid_priv, &act));
	ut_assertok(expo_render(exp));
	ut_asserteq(5423, video_compress_fb(uts, dev, false));
	...
	ut_assertok(cedit_do_action(exp, scn, vid_priv, &act));
	ut_assertok(expo_render(exp));
	ut_asserteq(4975, video_compress_fb(uts, dev, false));
	...
	ut_assertok(cedit_do_action(exp, scn, vid_priv, &act));
	ut_assertok(expo_render(exp));
	ut_asserteq(4859, video_compress_fb(uts, dev, false));
	...
	ut_assertok(expo_render(exp));
	ut_asserteq(5052, video_compress_fb(uts, dev, false));
