...
static int dm_test_acpi_emit_stream(struct unit_test_state *uts)
{
	...
	ut_asserteq(TEST_STREAM2[0], ptr[0]);
	ut_asserteq(TEST_STREAM2[1], ptr[1]);
...
DM_TEST(dm_test_acpi_interrupt, 0);
...
DM_TEST(dm_test_acpi_gpio_irq, 0);
