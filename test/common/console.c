...
static int console_test_calc_lines_env_invalid(struct unit_test_state *uts)
{
	...
	env_set("pager", "xyz");
	lines = calc_check_console_lines();
	/* Should return 0 since env_get_hex returns 0 for invalid values */
	ut_asserteq(0, lines);
