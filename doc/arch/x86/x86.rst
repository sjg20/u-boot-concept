...
<<<<<<< HEAD
shows a few common elements, taken from qemu-x86_64:
=======
...
========   ========================   ==========================================
   ...
   10000   CONFIG_SYS_CAR_ADDR
                                      top of initial SPL stack
   1b3e0   struct global_data         global_data
   1b7f0   SPL_SYS_MALLOC_F_LEN       early-malloc() region
   20000   CONFIG_SYS_CAR_ADDR +      Top of cache-as-RAM memory
              CONFIG_SYS_CAR_SIZE
   20000   CONFIG_BLOBLIST_ADDR       Blob list
   80000   PAGETABLE_BASE             Base address of page tables (24K)
   f0000   CONFIG_ROM_TABLE_ADDR      Base address of ROM tables
  110000   see x86_spl_init()         Stack top after early-SPL execution
========   ========================   ==========================================

If you are looking at the memory map in xPL, see x86_spl_init() for the logic.
