...
environment variable, which should contain a hex value. Set it to 0 (or leave
it unset) to disable the pager. If the variable is not present then the number
of lines in the video console is used. If there is no video console, then
