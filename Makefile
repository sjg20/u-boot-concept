...
ifneq ($(CONFIG_CHROMEOS),)
BINMAN_image.bin := -akeydir=$(srctree)/cros/data/devkeys \
	-abmpblk=$(srctree)/cros/data/bmpblk.bin -I $(srctree)/cros/data \
	"-ahardware-id=TEST 999" \
	"-afrid=123412 123" -acros-ec-rw-path=$(srctree)/cros/data/ecrw.bin -m \
	-i image
