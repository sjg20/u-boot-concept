...
static int do_siuinfo(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_carinfo(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	immap_t __iomem *immap = (immap_t __iomem *)CONFIG_SYS_IMMR;
...
static int do_iopinfo(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	immap_t __iomem *immap = (immap_t __iomem *)CONFIG_SYS_IMMR;
 ...
 */
static int do_iopset(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	uint rcode = 0;
	iopin_t iopin;
	static uint port;
...
static int do_brginfo(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	immap_t __iomem *immap = (immap_t __iomem *)CONFIG_SYS_IMMR;
