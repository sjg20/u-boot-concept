...
/* DP_VIDEO_CTL_8 */
#define VID_HRES_TH_SHIFT			4
#define VID_HRES_TH_MASK			(0xf << VID_HRES_TH_SHIFT)
#define VID_HRES_TH(x)				(((x) & VID_HRES_TH_MASK) << \
							VID_HRES_TH_SHIFT)
#define VID_VRES_TH_SHIFT			0
#define VID_VRES_TH_MASK			(0xf << VID_VRES_TH_SHIFT)
#define VID_VRES_TH(x)				(((x) & VID_VRES_TH_MASK) << \
							VID_VRES_TH_SHIFT)
...
#define AUX_BIT_PERIOD_DELAY(x)			((x) & AUX_BIT_PERIOD_MASK << \
							AUX_BIT_PERIOD_SHIFT)
#define AUX_HW_RETRY_INTERVAL_MASK		(3 << 3)
...
#define AUX_HW_RETRY_COUNT_SEL(x)		(((x) &		\
...
#define CHA_CRI(x)				(((x) & CHA_CRI_MASK) << \
							CHA_CRI_SHIFT)
#define CHA_STA					(1 << 2)
...
#define DEFER_COUNT(x)				(((x) & DEFER_COUNT_MASK) << \
							DEFER_COUNT_SHIFT)
...
/* DP_BUFFER_DATA_CTL */
#define BUF_CLR					(1 << 7)
#define BUF_DATA_COUNT_SHIFT			0
#define BUF_DATA_COUNT_MASK			0x1f
#define BUF_DATA_COUNT(x)			(((x) & \
						BUF_DATA_COUNT_MASK) << \
						BUF_DATA_COUNT_SHIFT)

/* DP_AUX_CH_CTL_1 */
#define AUX_LENGTH_SHIFT			4
#define AUX_LENGTH_MASK				0xf
#define AUX_LENGTH(x)				(((x - 1) &	\
						AUX_LENGTH_MASK) <<	\
						AUX_LENGTH_SHIFT)
...
#define DPCD_MAX_LANE_COUNT(x)			((x) & DPCD_MAX_LANE_COUNT_MASK)

/* DPCD_ADDR_LANE_COUNT_SET */
#define DPCD_ENHANCED_FRAME_EN			(1 << 7)
#define DPCD_LANE_COUNT_SET_MASK		0x1f
#define DPCD_LANE_COUNT_SET(x)			((x) & DPCD_LANE_COUNT_SET_MASK)
