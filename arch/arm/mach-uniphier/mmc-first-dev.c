...
static int do_mmcsetn(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	int dev;
...
static int do_sdsetn(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	int dev;
