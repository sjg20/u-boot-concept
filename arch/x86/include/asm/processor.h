...
#define X86_GDT_ENTRY_32BIT_CS		1
#define X86_GDT_ENTRY_32BIT_DS		2
#define X86_GDT_ENTRY_32BIT_FS		3
#define X86_GDT_ENTRY_16BIT_CS		4
#define X86_GDT_ENTRY_16BIT_DS		5
#define X86_GDT_ENTRY_16BIT_FLAT_CS	6
#define X86_GDT_ENTRY_16BIT_FLAT_DS	7
#define X86_GDT_NUM_ENTRIES		8
