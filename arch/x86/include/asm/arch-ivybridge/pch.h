...
#define PCH_EHCI1_DEV		PCI_BDF_CB(0, 0x1d, 0)
#define PCH_EHCI2_DEV		PCI_BDF_CB(0, 0x1a, 0)
#define PCH_XHCI_DEV		PCI_BDF_CB(0, 0x14, 0)
#define PCH_ME_DEV		PCI_BDF_CB(0, 0x16, 0)
#define PCH_PCIE_DEV_SLOT	28

/* PCI Configuration Space (D31:F0): LPC */
#define PCH_LPC_DEV		PCI_BDF_CB(0, 0x1f, 0)
...
#define PCH_IDE_DEV		PCI_BDF_CB(0, 0x1f, 1)
#define PCH_SATA_DEV		PCI_BDF_CB(0, 0x1f, 2)
#define PCH_SATA2_DEV		PCI_BDF_CB(0, 0x1f, 5)
#define INTR_LN			0x3c
...
#define PCH_SMBUS_DEV		PCI_BDF_CB(0, 0x1f, 3)
...
static inline __attribute__((always_inline)) uint8_t pci_io_read_config8(pci_dev_t dev, unsigned where)
{
	unsigned addr;
...
static inline __attribute__((always_inline)) uint8_t pci_mmio_read_config8(pci_dev_t dev, unsigned where)
{
        unsigned addr;
...
#endif
static inline __attribute__((always_inline)) uint8_t pci_read_config8(pci_dev_t dev, unsigned where)
{
...
static inline __attribute__((always_inline)) uint16_t pci_io_read_config16(pci_dev_t dev, unsigned where)
{
	unsigned addr;
#if !CONFIG_PCI_IO_CFG_EXT
        addr = (dev>>4) | where;
...
#if CONFIG_MMCONF_SUPPORT
static inline __attribute__((always_inline)) uint16_t pci_mmio_read_config16(pci_dev_t dev, unsigned where)
{
        unsigned addr;
...
static inline __attribute__((always_inline)) uint16_t pci_read_config16(pci_dev_t dev, unsigned where)
{
#if CONFIG_MMCONF_SUPPORT_DEFAULT
...
static inline __attribute__((always_inline)) uint32_t pci_io_read_config32(pci_dev_t dev, unsigned where)
{
	unsigned addr;
#if !CONFIG_PCI_IO_CFG_EXT
        addr = (dev>>4) | where;
...
#if CONFIG_MMCONF_SUPPORT
static inline __attribute__((always_inline)) uint32_t pci_mmio_read_config32(pci_dev_t dev, unsigned where)
{
        unsigned addr;
...
static inline __attribute__((always_inline)) uint32_t pci_read_config32(pci_dev_t dev, unsigned where)
{
#if CONFIG_MMCONF_SUPPORT_DEFAULT
...
static inline __attribute__((always_inline)) void pci_io_write_config8(pci_dev_t dev, unsigned where, uint8_t value)
{
	unsigned addr;
#if !CONFIG_PCI_IO_CFG_EXT
        addr = (dev>>4) | where;
...
#if CONFIG_MMCONF_SUPPORT
static inline __attribute__((always_inline)) void pci_mmio_write_config8(pci_dev_t dev, unsigned where, uint8_t value)
{
        unsigned addr;
        addr = CONFIG_MMCONF_BASE_ADDRESS | dev | where;
        write8(addr, value);
...
static inline __attribute__((always_inline)) void pci_write_config8(pci_dev_t dev, unsigned where, uint8_t value)
{
#if CONFIG_MMCONF_SUPPORT_DEFAULT
...
static inline __attribute__((always_inline)) void pci_io_write_config16(pci_dev_t dev, unsigned where, uint16_t value)
{
        unsigned addr;
#if !CONFIG_PCI_IO_CFG_EXT
        addr = (dev>>4) | where;
...
#if CONFIG_MMCONF_SUPPORT
static inline __attribute__((always_inline)) void pci_mmio_write_config16(pci_dev_t dev, unsigned where, uint16_t value)
{
        unsigned addr;
        addr = CONFIG_MMCONF_BASE_ADDRESS | dev | (where & ~1);
        write16(addr, value);
...
static inline __attribute__((always_inline)) void pci_write_config16(pci_dev_t dev, unsigned where, uint16_t value)
{
#if CONFIG_MMCONF_SUPPORT_DEFAULT
...
static inline __attribute__((always_inline)) void pci_io_write_config32(pci_dev_t dev, unsigned where, uint32_t value)
{
	unsigned addr;
#if !CONFIG_PCI_IO_CFG_EXT
        addr = (dev>>4) | where;
...
#if CONFIG_MMCONF_SUPPORT
static inline __attribute__((always_inline)) void pci_mmio_write_config32(pci_dev_t dev, unsigned where, uint32_t value)
{
        unsigned addr;
        addr = CONFIG_MMCONF_BASE_ADDRESS | dev | (where & ~3);
        write32(addr, value);
...
static inline __attribute__((always_inline)) void pci_write_config32(pci_dev_t dev, unsigned where, uint32_t value)
{
#if CONFIG_MMCONF_SUPPORT_DEFAULT
