...
struct efi_boot_services {
	...
	efi_status_t (EFIAPI *get_memory_map)(unsigned long *memory_map_size,
			struct efi_memory_descriptor *desc, unsigned long *key,
	...
	efi_status_t (EFIAPI *exit)(efi_handle_t handle,
			efi_status_t exit_status, unsigned long exitdata_size,
			s16 *exitdata);
	void *unload_image;
...
#define UGA_PROTOCOL_GUID \
    EFI_GUID(  0x982c298b, 0xf4fa, 0x41cb, 0xb8, 0x38, 0x77, 0xaa, 0x68, 0x8f, 0xb8, 0x39 )

#define PCI_IO_PROTOCOL_GUID \
...
#define SIMPLE_NETWORK_PROTOCOL_GUID \
...
#define SIMPLE_TEXT_IN_PROTOCOL_GUID \
