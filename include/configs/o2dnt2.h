...
#define CONFIG_O2DNT2		1	/* ... on O2DNT2 board */
...
#if (CONFIG_SYS_TEXT_BASE == 0xFC000000) /* Boot low with 16 MB Flash */
#define CONFIG_SYS_LOWBOOT	1
#else
/*#error "CONFIG_SYS_TEXT_BASE must be 0xFC000000"*/
#endif
...
# define CONFIG_AUTOBOOT_PROMPT "Autobooting in %d seconds, press password to stop\n,bootdelay"
...
#define CONFIG_SYS_FLASH_SIZE		0x02000000      /* maximum 64MB */
...
/*
 * No auto negotiation check at bootup
 */
/*#define CONFIG_NO_AN_CHECK      1*/

/*
 * GPIO configuration
 */
#define CONFIG_SYS_GPS_PORT_CONFIG	0x8000A004	/* CS1 SDRAM activate + no CAN + no PCI*/
...
#define CONFIG_SYS_GPIO_DATAVALUE	0x00000000	/* Set PSC1_1 to 1 and rest to 0 */
