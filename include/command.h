...
extern int do_run(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[]);
#endif

/* common/command.c */
int _do_help (struct cmd_tbl *cmd_start, int cmd_items, struct cmd_tbl * cmdtp, int
 ...
 *
 * void function (struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[]);
 */
...
extern int do_bootd(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[]);
#endif
...
extern int do_bootz(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[]);

extern int do_booti(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[]);
...
extern int do_poweroff(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[]);
...
#define U_BOOT_SUBCMDS_DO_CMD(_cmdname)					\
	static int do_##_cmdname(struct cmd_tbl *cmdtp, int flag, int argc,	\
				 char * const argv[], int *repeatable)	\
	{								\
