 ...
 */
int gbb_init(void *gbb, struct udevice *fw_dev, uint32_t gbb_offset,
	     size_t gbb_size);
 ...
 * @return zero if this succeeds, non-zero if this fails
 */
int gbb_read_bmp_block(void *gbb, struct udevice *fw_dev, uint32_t gbb_offset,
		       size_t gbb_size);
 ...
 * @return zero if this succeeds, non-zero if this fails
 */
int gbb_read_recovery_key(void *gbb, struct udevice *fw_dev,
